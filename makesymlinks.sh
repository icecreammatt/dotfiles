...
files="gitconfig gitignore_global bash_profile zshrc xvimrc vimrc minttyrc tmux.conf tmux.theme zsh_aliases"    # list of files/folders to symlink in homedir
